...
%PLOT overloads PLOT for the class SpawnField.
%  PLOT plots the spawning distribution onto a map of the corresponding domain.
%  The only possible domain is currently Georges Bank. This is unlikely to
%  change soon, but the class should be easy to generalize for any domain.
%
...
%
%See also: SpawnField, Krige, GonData
